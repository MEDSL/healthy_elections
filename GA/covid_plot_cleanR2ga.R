...
cases_plot_all <- ggplot(ts_covid_all, aes(x = Date, y = new_cases)) + 
  ...
  geom_vline(aes(xintercept=18335, color="#37C256" ), linetype=4, show.legend = F,lwd=1.4) + 
  geom_vline(aes(xintercept=18414, color="#948DE5" ), linetype=3, show.legend = F,lwd=1.4) + 
